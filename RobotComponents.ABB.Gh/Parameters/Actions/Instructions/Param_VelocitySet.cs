...
namespace RobotComponents.ABB.Gh.Parameters.Actions.Instructions
{
    ...
    /// </summary>
    public class Param_VelocitySet : GH_PersistentParam<GH_VelocitySet>
    {
        /// <summary>
        /// Initializes a new instance of the GH_PersistentParam<GH_VelocitySet> class
        /// </summary>
        public Param_VelocitySet()
          : base(new GH_InstanceDescription("Velocity Set Parameter", "VSP",
        ...
        protected override GH_GetterResult Prompt_Plural(ref List<GH_VelocitySet> values)
        {
            return GH_GetterResult.cancel;
        }

        protected override GH_GetterResult Prompt_Singular(ref GH_VelocitySet value)
        {
            return GH_GetterResult.cancel;
        }
