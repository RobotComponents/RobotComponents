...
namespace RobotComponents.Definitions.Presets
{
    ...
    public static class IRB6650S_200_300
    {
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 2
            axisPlanes.Add(new Plane(
                new Point3d(600, 0, 630),
                new Vector3d(0, 1, 0)));
            // Axis 3
            axisPlanes.Add(new Plane(
                new Point3d(600, 0, 630 + 1280),
                new Vector3d(0, 1, 0)));
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(830, 0, 630 + 1280 + 200),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(600 + 1142, 0, 630 + 1280 + 200),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(600 + 1142 + 200, 0, 630 + 1280 + 200),
                new Vector3d(1, 0, 0)));
