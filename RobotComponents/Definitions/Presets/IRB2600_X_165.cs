...
namespace RobotComponents.Definitions.Presets
{
    ...
    public static class IRB2600_X_165
    {
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 3
            axisPlanes.Add(new Plane(
                new Point3d(150.0, 0, 445.0 + 700.0),
                new Vector3d(0, 1, 0)));
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(437.5, 0, 445.0 + 700.0 + 115.0),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(150.0 + 795.0, 0, 445.0 + 700.0 + 115.0),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(150.0 + 795.0 + 85.0, 0, 445.0 + 700.0 + 115.0),
                new Vector3d(1, 0, 0)));
