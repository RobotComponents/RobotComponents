...
{
    /// <summary>
    /// RobotComponents IRB6640-185/2.80 preset component. An inherent from the GH_Component Class.
    /// </summary>
    public class IRB6640_185_2_80_Component : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB6640_185_2_80_Component class.
        /// </summary>
        public IRB6640_185_2_80_Component()
          : base("ABB IRB6640-185/2.8", "IRB6640",
              "An ABB IRB6640-185/2.8 Robot Info preset component."
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            string name = "IRB6640-185/2.80";
            RobotInfo robotInfo = new RobotInfo();

            try
            {
                robotInfo = IRB6640_185_280.GetRobotInfo(name, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
        ...
        {
            get { return new Guid("8DE692EF-90E5-4E2C-9FA1-17DF4D71AC23"); }
        }
