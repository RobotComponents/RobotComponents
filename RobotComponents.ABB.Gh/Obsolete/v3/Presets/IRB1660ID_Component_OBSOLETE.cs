...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    public class IRB1660ID_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB1660ID_Component class.
        /// </summary>
        public IRB1660ID_Component_OBSOLETE()
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB1660ID_4_155, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
