...
namespace RobotComponents.Definitions.Presets
{
    ...
    /// </summary>
    public static class IRB6700_175_305
    {
        /// <summary>
        /// Returns a new IRB6700-175/3.05 Robot instance.
        /// </summary>
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            // Base
            linkString = RobotComponents.Properties.Resources.IRB6700_175_3_05_link_0;
            meshes.Add((Mesh)HelperMethods.ByteArrayToObject(System.Convert.FromBase64String(linkString)));
            // Axis 1
            linkString = RobotComponents.Properties.Resources.IRB6700_175_3_05_link_1;
            meshes.Add((Mesh)HelperMethods.ByteArrayToObject(System.Convert.FromBase64String(linkString)));
            // Axis 2
            linkString = RobotComponents.Properties.Resources.IRB6700_175_3_05_link_2;
            meshes.Add((Mesh)HelperMethods.ByteArrayToObject(System.Convert.FromBase64String(linkString)));
            // Axis 3
            linkString = RobotComponents.Properties.Resources.IRB6700_175_3_05_link_3;
            meshes.Add((Mesh)HelperMethods.ByteArrayToObject(System.Convert.FromBase64String(linkString)));
            // Axis 4
            linkString = RobotComponents.Properties.Resources.IRB6700_175_3_05_link_4;
            meshes.Add((Mesh)HelperMethods.ByteArrayToObject(System.Convert.FromBase64String(linkString)));
            // Axis 5
            linkString = RobotComponents.Properties.Resources.IRB6700_175_3_05_link_5;
            meshes.Add((Mesh)HelperMethods.ByteArrayToObject(System.Convert.FromBase64String(linkString)));
            // Axis 6
            linkString = RobotComponents.Properties.Resources.IRB6700_175_3_05_link_6;
            meshes.Add((Mesh)HelperMethods.ByteArrayToObject(System.Convert.FromBase64String(linkString)));
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(320 + 1592.5, 0, 780 + 1135 + 200),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(320 + 1592.5 + 200, 0, 780 + 1135 + 200),
                new Vector3d(1, 0, 0)));
