...
namespace RobotComponents.ABB.Presets.Robots
{
    ...
    {
        /// <summary>
        /// Returns a new IRB4600-40/2.55 Robot instance.
        /// </summary>
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                Mesh.FromJSON(Properties.Resources.IRB4600_40_255_link_0) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB4600_40_255_link_1) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB4600_40_255_link_2) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB4600_40_255_link_3) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB4600_40_255_link_4) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB4600_40_255_link_5) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB4600_40_255_link_6) as Mesh,
            };
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 2
            axisPlanes.Add(new Plane(
                new Point3d(175, 0, 495),
                new Vector3d(0, 1, 0)));
            // Axis 3
            axisPlanes.Add(new Plane(
                new Point3d(175, 0, 1590),
                new Vector3d(0, 1, 0)));
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(505.60, 0, 1765),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(1445, 0, 1765),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(1580, 0, 1765),
                new Vector3d(1, 0, 0)));
