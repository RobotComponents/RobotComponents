...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    public class IRB120_3_0_58_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB120_3_0_58_Component class.
        /// </summary>
        public IRB120_3_0_58_Component_OBSOLETE()
          : base("ABB IRB120-3/0.58", "IRB120",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB120_3_058, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
