...
{
    /// <summary>
    /// RobotComponents Action : Joint Configuration Control component. An inherent from the GH_Component Class.
    /// </summary>
    public class JointConfigurationControlComponent : GH_Component
    {
        /// <summary>
