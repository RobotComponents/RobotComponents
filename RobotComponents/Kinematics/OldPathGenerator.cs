...
namespace RobotComponents.Kinematics
{
    ...
    public class OldPathGenerator
    {
        ...
        public OldPathGenerator(Robot robotInfo)
        {
            _planes = new List<Plane>();
            _paths = new List<Curve>();
            _internalAxisValues = new List<List<double>>();
        ...
        public OldPathGenerator(OldPathGenerator generator)
        {
            // Set fields
        ...
        public OldPathGenerator Duplicate()
        {
            return new OldPathGenerator(this);
        }
        #endregion
