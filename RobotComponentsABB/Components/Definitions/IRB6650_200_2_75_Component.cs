...
{
    /// <summary>
    /// RobotComponents IRB6650-200/2.75 preset component. An inherent from the GH_Component Class.
    /// </summary>
    public class IRB6650_200_2_75_Component : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB6650_200_2_75_Component class.
        /// </summary>
        public IRB6650_200_2_75_Component()
          : base("ABB IRB6650-200/2.75", "IRB6650",
              "An ABB IRB6650-200/2.75 Robot Info preset component."
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robotInfo = IRB6650_200_275.GetRobotInfo(name, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
        ...
        {
            get { return new Guid("AB66026F-6FF9-4FB3-902B-71598C524064"); }
        }
