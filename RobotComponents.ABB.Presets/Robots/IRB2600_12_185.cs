...
namespace RobotComponents.ABB.Presets.Robots
{
    ...
    public static class IRB2600_12_185
    {
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                Mesh.FromJSON(Properties.Resources.IRB2600_12_185_link_0) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB2600_12_185_link_1) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB2600_12_185_link_2) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB2600_12_185_link_3) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB2600_12_185_link_4) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB2600_12_185_link_5) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB2600_12_185_link_6) as Mesh,
            };
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(437.5, 0, 445.0 + 900.0 + 115),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(150.0 + 795.0, 0, 445.0 + 900.0 + 115),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(150.0 + 795.0 + 85.0, 0, 445.0 + 900.0 + 115),
                new Vector3d(1, 0, 0)));
