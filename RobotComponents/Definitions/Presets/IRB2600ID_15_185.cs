...
namespace RobotComponents.Definitions.Presets
{
    ...
    public static class IRB2600ID_15_185
    {
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            // Base
            linkString = RobotComponents.Properties.Resources.IRB2600ID_15_1_85_link_0;
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 3
            axisPlanes.Add(new Plane(
                new Point3d(150.0, 0, 445.0 + 900.0),
                new Vector3d(0, 1, 0)));
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(393.0, 0, 445.0 + 900.0 + 150.0),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(150.0 + 786.0, 0, 445.0 + 900.0 + 150.0),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(150.0 + 786.0 + 135.0, 0, 445.0 + 900.0 + 150.0),
                new Vector3d(1, 0, 0)));
