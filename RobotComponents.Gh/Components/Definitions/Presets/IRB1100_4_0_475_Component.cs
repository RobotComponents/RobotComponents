...
namespace RobotComponents.Gh.Components.Definitions.Presets
{
    ...
    /// </summary>
    public class IRB1100_4_0_475_Component : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB110_4_0_475_Component class.
        /// </summary>
        public IRB1100_4_0_475_Component()
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robotInfo = IRB1100_4_0475.GetRobot(name, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
