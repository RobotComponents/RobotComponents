...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    public class IRB1200_5_90_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB1200_5_90_Component class.
        /// </summary>
        public IRB1200_5_90_Component_OBSOLETE()
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB1200_5_090, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
