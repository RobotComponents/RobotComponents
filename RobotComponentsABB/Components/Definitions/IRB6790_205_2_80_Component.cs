...
{
    /// <summary>
    /// RobotComponents IRB6790-205/2.8 preset component. An inherent from the GH_Component Class.
    /// </summary>
    public class IRB6790_205_2_80_Component : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB6790_205_2_80_Component class.
        /// </summary>
        public IRB6790_205_2_80_Component()
          : base("ABB IRB6790-205/2.8", "IRB6790",
              "An ABB IRB6790-205/2.8 Robot Info preset component."
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robotInfo = IRB6790_205_280.GetRobotInfo(name, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
        ...
        {
            get { return new Guid("A79A07A2-FD93-48AD-9F00-5256CD05B227"); }
        }
