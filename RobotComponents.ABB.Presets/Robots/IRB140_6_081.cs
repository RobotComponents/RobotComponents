...
namespace RobotComponents.ABB.Presets.Robots
{
    ...
    {
        /// <summary>
        /// Returns a new IRB140-6/0.81 Robot instance.
        /// </summary>
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                Mesh.FromJSON(Properties.Resources.IRB140_6_081_link_0) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB140_6_081_link_1) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB140_6_081_link_2) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB140_6_081_link_3) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB140_6_081_link_4) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB140_6_081_link_5) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB140_6_081_link_6) as Mesh,
            };
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 2
            axisPlanes.Add(new Plane(
                new Point3d(70.0, 0, 352),
                new Vector3d(0, 1, 0)));
            // Axis 3
            axisPlanes.Add(new Plane(
                new Point3d(70.0, 0, 712),
                new Vector3d(0, 1, 0)));
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(308.5, 0, 712),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(450, 0, 712),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(515, 0, 712),
                new Vector3d(1, 0, 0)));
