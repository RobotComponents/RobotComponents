...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    public class IRB6790_235_2_65_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB6790_235_2_65_Component class.
        /// </summary>
        public IRB6790_235_2_65_Component_OBSOLETE()
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB6790_235_265, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
