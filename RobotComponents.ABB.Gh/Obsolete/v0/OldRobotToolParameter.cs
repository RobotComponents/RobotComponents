...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    /// </summary>
    [Obsolete("This parameter is OBSOLETE and will be removed in the future. Use Param_RobotTool instead.", false)]
    public class OldRobotToolParameter : GH_PersistentGeometryParam<GH_RobotTool>, IGH_PreviewObject
    {
        /// <summary>
        /// Initializes a new instance of the RobotToolParameter class
        /// </summary>
        public OldRobotToolParameter()
        ...
        {
            get { return new Guid("5945EE42-6E5F-4AFE-BAB6-E17BE1275AD8"); }
        }
