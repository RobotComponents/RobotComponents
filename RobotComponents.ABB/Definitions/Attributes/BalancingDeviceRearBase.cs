...
namespace RobotComponents.ABB.Definitions.Attributes
{
    ...
    /// </summary>
    [Serializable()]
    internal class BalancingDeviceRearBase : ISerializable
    {
        #region fields
        ...
        protected BalancingDeviceRearBase(SerializationInfo info, StreamingContext context)
        {
        ...
        /// Empty constructor.
        /// </summary>
        internal BalancingDeviceRearBase()
        {
        }
        #endregion
    }
