...
{
    /// <summary>
    /// RobotComponents IRB1520ID-4/1.5 preset component. An inherent from the GH_Component Class.
    /// </summary>
    [Obsolete("This component is OBSOLETE and will be removed in the future.", false)]
    public class IRB1520ID_4_1_50_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB1520ID_4_1_50_Component class.
        /// </summary>
        public IRB1520ID_4_1_50_Component_OBSOLETE()
          : base("ABB IRB1520ID-4/1.5", "IRB1520ID",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB1520ID_4_150, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
        ...
        {
            get { return new Guid("6AD6E6B2-C831-45D6-9E86-687BD2B1617F"); }
        }
        #endregion
