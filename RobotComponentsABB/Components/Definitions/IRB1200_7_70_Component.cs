...
namespace RobotComponentsABB.Components.Definitions
{
    ...
    public class IRB1200_7_70_Component : GH_Component
    {
        ...
        public IRB1200_7_70_Component()
          : base("ABB IRB1200-7/0.7", "IRB1200",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (externalAxis.Count != 0)
            {
                ...
                robotInfo = new RobotInfo("IRB1200-7/0.7", meshes, axisPlanes, axisLimits, Plane.WorldXY, mountingFrame, toolGoo.Value, externalAxis);
            ...
            {
                robotInfo = new RobotInfo("IRB1200-7/0.7", meshes, axisPlanes, axisLimits, Plane.WorldXY, mountingFrame, toolGoo.Value);
                Transform trans = Transform.PlaneToPlane(Plane.WorldXY, positionPlane);
                robotInfo.Transfom(trans);
            }
