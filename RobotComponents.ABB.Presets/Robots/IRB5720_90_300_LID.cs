...
{
    /// <summary>
    /// Represents a collection of methods to get the IRB5720-90/3.0-LID Robot instance.
    /// </summary>
    public static class IRB5720_90_300_LID
    {
        /// <summary>
        /// Returns a new IRB5720-90/3.0-LID Robot instance.
        /// </summary>
        ...
        {
            string name = "IRB5720-90/3.0-LID";
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5720_90_3_00_LID_link_0)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5720_90_3_00_LID_link_1)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5720_90_3_00_LID_link_2)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5720_90_3_00_LID_link_3)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5720_90_3_00_LID_link_4)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5720_90_3_00_LID_link_5)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5720_90_3_00_LID_link_6))
            };
        ...
        {
            Plane[] axisPlanes = Robot.GetAxisPlanesFromKinematicsParameters(Plane.WorldXY, 320, -200, 0, 0, 670, 1120, 1547.5, 333, out _);
        ...
        {
            Robot.GetAxisPlanesFromKinematicsParameters(Plane.WorldXY, 320, -200, 0, 0, 670, 1120, 1547.5, 333, out Plane mountingFrame);
