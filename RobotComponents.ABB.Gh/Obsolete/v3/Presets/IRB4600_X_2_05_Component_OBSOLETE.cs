...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    public class IRB4600_X_2_05_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB4600_40_2_05_Component class.
        /// </summary>
        public IRB4600_X_2_05_Component_OBSOLETE()
          : base("ABB IRB4600-X/2.05", "IRB4600",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB4600_45_205, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
