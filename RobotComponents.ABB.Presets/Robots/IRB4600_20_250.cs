...
namespace RobotComponents.ABB.Presets.Robots
{
    ...
    {
        /// <summary>
        /// Returns a new IRB4600-20/2.5 Robot instance.
        /// </summary>
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                Mesh.FromJSON(Properties.Resources.IRB4600_20_250_link_0) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB4600_20_250_link_1) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB4600_20_250_link_2) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB4600_20_250_link_3) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB4600_20_250_link_4) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB4600_20_250_link_5) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB4600_20_250_link_6) as Mesh,
            };
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 3
            axisPlanes.Add(new Plane(
                new Point3d(175, 0, 495.00 + 1095),
                new Vector3d(0, 1, 0)));
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(505.60, 0, 495.00 + 1095.00 + 175),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(175.0 + 1230.5, 0, 495.00 + 1095.00 + 175),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(175.0 + 1230.5 + 85.0, 0, 495.00 + 1095.00 + 175),
                new Vector3d(1, 0, 0)));
