...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    public class IRB2600ID_15_1_85_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB2600ID_15_1_85_Component class.
        /// </summary>
        public IRB2600ID_15_1_85_Component_OBSOLETE()
          : base("ABB IRB2600ID-15/1.85", "IRB2600",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB2600ID_15_185, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
