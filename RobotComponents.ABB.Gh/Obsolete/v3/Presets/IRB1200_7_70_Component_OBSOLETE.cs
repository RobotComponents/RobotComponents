...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    public class IRB1200_7_70_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB1200_7_70_Component class.
        /// </summary>
        public IRB1200_7_70_Component_OBSOLETE()
          : base("ABB IRB1200-7/0.7", "IRB1200",
              "An ABB IRB1200-7/0.7 Robot preset component."
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB1200_7_070, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
