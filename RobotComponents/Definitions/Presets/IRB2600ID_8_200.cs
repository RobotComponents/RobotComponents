...
namespace RobotComponents.Definitions.Presets
{
    ...
    public static class IRB2600ID_8_200
    {
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            // Base
            linkString = RobotComponents.Properties.Resources.IRB2600ID_8_2_0_link_0;
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(388.0, 0, 445.0 + 900.0 + 150.0),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(150.0 + 938.0, 0, 445.0 + 900.0 + 150.0),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(150.0 + 938.0 + 200.0, 0, 445.0 + 900.0 + 150.0),
                new Vector3d(1, 0, 0)));
