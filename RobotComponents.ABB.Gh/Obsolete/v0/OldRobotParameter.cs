...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    /// </summary>
    [Obsolete("This parameter is OBSOLETE and will be removed in the future. Use Param_Robot instead.", false)]
    public class OldRobotParameter : GH_PersistentGeometryParam<GH_Robot>, IGH_PreviewObject
    {
        /// <summary>
        /// Initializes a new instance of the GH_PersistentGeometryParam<GH_Robot> class
        /// </summary>
        public OldRobotParameter()
          : base(new GH_InstanceDescription("Robot", "R",
        ...
        {
            get { return new Guid("7EC9AD86-6402-41A2-845D-EAB80119B12C"); }
        }
