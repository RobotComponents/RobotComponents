...
{
    /// <summary>
    /// RobotComponents IRB6650S-125/3.5 preset component. An inherent from the GH_Component Class.
    /// </summary>
    public class IRB6650S_125_3_50_Component : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB6650S_125_3_50_Component class.
        /// </summary>
        public IRB6650S_125_3_50_Component()
          : base("ABB IRB6650S-125/3.5", "IRB6650S",
                "Definition" + System.Environment.NewLine + System.Environment.NewLine +
              "An ABB IRB6650S-125/3.5 Robot Info preset component."
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robotInfo = IRB6650S_125_350.GetRobotInfo(name, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
        ...
        {
            get { return Properties.Resources.IRB6650S_Icon; }
        }
        ...
        {
            get { return new Guid("DC47D62B-1D7D-4917-B6E9-2A9C7F19A771"); }
        }
