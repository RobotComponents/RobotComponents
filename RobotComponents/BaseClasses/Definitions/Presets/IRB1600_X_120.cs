...
{
    /// <summary>
    /// Defines the IRB1600-X/1.20
    /// </summary>
    public static class IRB1600_X_120
    {
        /// <summary>
        /// Defines the IRB1600-X/1.20 Robot Info
        /// </summary>
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            // Base
            linkString = RobotComponents.Properties.Resources.IRB1600_X_1_2_link_0;
        ...
        public static List<Interval> GetAxisLimits()
        {
            ...
            axisLimits.Add(new Interval(-90, 120));
            axisLimits.Add(new Interval(-245, 65));
