...
{
    /// <summary>
    /// Represents a collection of methods to get the IRB5720-155/2.6-LID Robot instance.
    /// </summary>
    public static class IRB5720_155_260_LID
    {
        /// <summary>
        /// Returns a new IRB5720-155/2.6-LID Robot instance.
        /// </summary>
        ...
        {
            string name = "IRB5720-155/2.6-LID";
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                Mesh.FromJSON(Properties.Resources.IRB5720_155_260_LID_link_0) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB5720_155_260_LID_link_1) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB5720_155_260_LID_link_2) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB5720_155_260_LID_link_3) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB5720_155_260_LID_link_4) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB5720_155_260_LID_link_5) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB5720_155_260_LID_link_6) as Mesh
            };
        ...
        {
            Plane[] axisPlanes = Robot.GetAxisPlanesFromKinematicsParameters(Plane.WorldXY, 320, -200, 0, 0, 670, 1120, 1142.5, 346, out _);
        ...
        {
            Robot.GetAxisPlanesFromKinematicsParameters(Plane.WorldXY, 320, -200, 0, 0, 670, 1120, 1142.5, 346, out Plane mountingFrame);
