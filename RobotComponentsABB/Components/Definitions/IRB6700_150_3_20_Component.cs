...
{
    /// <summary>
    /// RobotComponents IRB6700-150/3.2 preset component. An inherent from the GH_Component Class.
    /// </summary>
    public class IRB6700_150_3_20_Component : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB6700_150_3_20_Component class.
        /// </summary>
        public IRB6700_150_3_20_Component()
          : base("ABB IRB6700-150/3.2", "IRB6700",
              "An ABB IRB6700-150/3.2 Robot Info preset component."
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robotInfo = IRB6700_150_320.GetRobotInfo(name, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
        ...
        {
            get { return new Guid("3638EE31-6054-4E5B-A616-5F218C93A1F1"); }
        }
