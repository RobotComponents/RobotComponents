...
{
    /// <summary>
    /// RobotComponents IRB1100-4/0.475 preset component. An inherent from the GH_Component Class.
    /// </summary>
    [Obsolete("This component is OBSOLETE and will be removed in the future.", false)]
    public class IRB1100_4_0_475_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB110_4_0_475_Component class.
        /// </summary>
        public IRB1100_4_0_475_Component_OBSOLETE()
          : base("ABB IRB1100-4/0.475", "IRB1100",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB1100_4_0475, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
        ...
        {
            get { return Properties.Resources.IRB1100_Icon; }
        }
        ...
        {
            get { return new Guid("C93A98CC-70B4-4A90-B5F3-1E6CE861A13C"); }
        }
        #endregion
