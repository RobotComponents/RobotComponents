...
namespace RobotComponents.Gh.Components.CodeGeneration
{
    ...
    public class RobotJointPositionComponentDataTreeGenerator : GH_Component
    {
        ...
        {
            get { return GH_Exposure.hidden; } // This component is hidden. It is only used to create a datatree inside the real Robot Joint Position component (according to the Grasshopper logic)
        }
