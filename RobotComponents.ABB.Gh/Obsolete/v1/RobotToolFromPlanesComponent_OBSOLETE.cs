...
namespace RobotComponents.ABB.Gh.Components.Obsolete
{
    ...
    public class RobotToolFromPlanesComponent_OBSOLETE : GH_Component, IGH_VariableParameterComponent, IObjectManager
    {
        #region fields
        ...
        /// </summary>
        public RobotToolFromPlanesComponent_OBSOLETE()
