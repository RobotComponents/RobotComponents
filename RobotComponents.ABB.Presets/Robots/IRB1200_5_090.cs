...
namespace RobotComponents.ABB.Presets.Robots
{
    ...
    public static class IRB1200_5_090
    {
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                Mesh.FromJSON(Properties.Resources.IRB1200_5_090_link_0) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1200_5_090_link_1) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1200_5_090_link_2) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1200_5_090_link_3) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1200_5_090_link_4) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1200_5_090_link_5) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1200_5_090_link_6) as Mesh,
            };
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 3
            axisPlanes.Add(new Plane(
                new Point3d(0, 0, 847.1),
                new Vector3d(0, 1, 0)));
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(288.5, 0, 889.1),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(451, 0, 889.1),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
