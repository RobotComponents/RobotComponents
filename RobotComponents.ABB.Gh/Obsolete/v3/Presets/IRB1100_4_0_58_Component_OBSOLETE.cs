...
{
    /// <summary>
    /// RobotComponents IRB1100-4/0.58 preset component. An inherent from the GH_Component Class.
    /// </summary>
    [Obsolete("This component is OBSOLETE and will be removed in the future.", false)]
    public class IRB1100_4_0_58_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB110_4_0_58_Component class.
        /// </summary>
        public IRB1100_4_0_58_Component_OBSOLETE()
          : base("ABB IRB1100-4/0.58", "IRB1100",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB1100_4_058, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
        ...
        {
            get { return new Guid("9E83A788-2D86-4941-B426-01CAE7685B3C"); }
        }
        #endregion
