...
namespace RobotComponents.Gh.Components.CodeGeneration
{
    ...
    /// </summary>
    public class ExternalJointPositionComponentDataTreeGenerator : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public ExternalJointPositionComponentDataTreeGenerator()
        ...
        {
            get { return GH_Exposure.hidden; } // This component is hidden. It is only used to create a datatree inside the real External Joint Position component (according to the Grasshopper logic)
        }
