...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    public class IRB2600_X_1_65_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB2600_X_1_65_Component class.
        /// </summary>
        public IRB2600_X_1_65_Component_OBSOLETE()
          : base("ABB IRB2600-X/1.65", "IRB2600",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB2600_12_165, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
