...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    public class InverseKinematicsComponent_OBSOLETE2 : GH_Component, IGH_VariableParameterComponent
    {
        ...
        public override bool Write(GH_IWriter writer)
        {
            ...
            writer.SetByteArray("Previous Robot Joint Position", RobotComponents.Utils.Serialization.ObjectToByteArray(_previousRobotJointPosition));
        ...
        public override bool Read(GH_IReader reader)
        {
            ...
            {
                _previousRobotJointPosition = new RobotJointPosition();
            }
