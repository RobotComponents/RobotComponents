...
{
    /// <summary>
    /// Inverse kinematics for the CRB15000-5/0.95 robot (GoFa 5) with ik-geo.
    /// </summary>
    /// <remarks>
    /// This class wraps the ikgeo library generated for the CRB15000-5/0.95 robot (GoFa 5). 
    /// </remarks>
...
/*        public IkGeoSolver(Robot robot)
        ...
        public void Compute_CRB15000_5_095(Plane endPlane)
        {
            ...
            {
                throw new Exception("The IkGeo Kinematics Solver cannot be used. The operating system is not 64-bit.");
            }
...
/*        public List<RobotJointPosition> RobotJointPositions
        ...
        #region dll import
        [DllImport("ikgeoInterface_GoFa_5.dll", EntryPoint = "computeInverseKinematics")]
        private static unsafe extern Vector6d* computeIK_CRB15000_5_095(ref IkGeo.Geometry.Vector3d eePos, ref IkGeo.Geometry.Quaternion eeOri, out int n_sol);
        #endregion
    }
}
