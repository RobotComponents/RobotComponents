...
{
    /// <summary>
    /// Represents a collection of methods to get the IRB1600-10/1.20 Robot instance.
    /// </summary>
    public static class IRB1600_10_120
    {
        /// <summary>
        /// Returns a new IRB1600-10/1.20 Robot instance.
        /// </summary>
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                Mesh.FromJSON(Properties.Resources.IRB1600_10_120_link_0) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1600_10_120_link_1) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1600_10_120_link_2) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1600_10_120_link_3) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1600_10_120_link_4) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1600_10_120_link_5) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1600_10_120_link_6) as Mesh,
            };
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 3
            axisPlanes.Add(new Plane(
                new Point3d(150.0, 0, 961.5),
                new Vector3d(0, 1, 0)));
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(464.0, 0, 961.5),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(750, 0, 961.50),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(815, 0, 961.50),
                new Vector3d(1, 0, 0)));
