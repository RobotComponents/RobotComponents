...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    public class IRB6650_125_3_20_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB6650_125_3_20_Component class.
        /// </summary>
        public IRB6650_125_3_20_Component_OBSOLETE()
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB6650_125_320, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
