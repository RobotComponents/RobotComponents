...
namespace RobotComponents.Definitions.Presets
{
    ...
    public static class IRB6620_150_220
    {
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 3
            axisPlanes.Add(new Plane(
                new Point3d(320, 0, 680.0 + 975.0),
                new Vector3d(0, 1, 0)));
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(502, 0, 680.0 + 975.0 + 200.0),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(320.0 + 887.0, 0, 680.0 + 975.0 + 200.0),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(320.0 + 887.0 + 200.0, 0, 680.0 + 975.0 + 200.0),
                new Vector3d(1, 0, 0)));
