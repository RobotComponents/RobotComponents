...
namespace RobotComponentsABB.Parameters.Actions
{
    ...
    /// </summary>
    public class ExternalJointPositionParameter : GH_PersistentParam<GH_ExternalJointPosition>
    {
        /// <summary>
        /// Initializes a new instance of the GH_PersistentParam<ExternalJointPositionGoo> class
        /// </summary>
        public ExternalJointPositionParameter()
          : base(new GH_InstanceDescription("Ext Joint Position", "EJ",
                "Maintains the Ext Joint Position data."
