...
namespace RobotComponents.ABB.Presets.Robots
{
    ...
    public static class IRB1100_4_0475
    {
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                Mesh.FromJSON(Properties.Resources.IRB1100_4_0475_link_0) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1100_4_0475_link_1) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1100_4_0475_link_2) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1100_4_0475_link_3) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1100_4_0475_link_4) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1100_4_0475_link_5) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1100_4_0475_link_6) as Mesh,
            };
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(45.5, 0, 562),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(250, 0, 562),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(314, 0, 562),
                new Vector3d(1, 0, 0)));
