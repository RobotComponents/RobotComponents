...
namespace RobotComponents.Components
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the IRB1600_X_1_2_Component class.
        /// </summary>
        public IRB1600_X_1_20_Component()
          : base("ABB_IRB1600-X/1.2", "IRB1600",
              "An ABB IRB1600-X/1.2 Robot Info preset component."
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // Base
            string linkString = RobotComponents.Properties.Resources.IRB1600_X_1_2_link_0;
            meshes.Add((Mesh)GH_Convert.ByteArrayToCommonObject<GeometryBase>(System.Convert.FromBase64String(linkString)));
            // Axis 1
            linkString = RobotComponents.Properties.Resources.IRB1600_X_1_2_link_1;
            meshes.Add((Mesh)GH_Convert.ByteArrayToCommonObject<GeometryBase>(System.Convert.FromBase64String(linkString)));
            // Axis 2
            linkString = RobotComponents.Properties.Resources.IRB1600_X_1_2_link_2;
            meshes.Add((Mesh)GH_Convert.ByteArrayToCommonObject<GeometryBase>(System.Convert.FromBase64String(linkString)));
            // Axis 3
            linkString = RobotComponents.Properties.Resources.IRB1600_X_1_2_link_3;
            meshes.Add((Mesh)GH_Convert.ByteArrayToCommonObject<GeometryBase>(System.Convert.FromBase64String(linkString)));
            // Axis 4
            linkString = RobotComponents.Properties.Resources.IRB1600_X_1_2_link_4;
            meshes.Add((Mesh)GH_Convert.ByteArrayToCommonObject<GeometryBase>(System.Convert.FromBase64String(linkString)));
            // Axis 5
            linkString = RobotComponents.Properties.Resources.IRB1600_X_1_2_link_5;
            meshes.Add((Mesh)GH_Convert.ByteArrayToCommonObject<GeometryBase>(System.Convert.FromBase64String(linkString)));
            // Axis 6
            linkString = RobotComponents.Properties.Resources.IRB1600_X_1_2_link_6;
            meshes.Add((Mesh)GH_Convert.ByteArrayToCommonObject<GeometryBase>(System.Convert.FromBase64String(linkString)));
            ...
            // Axis 3
            axisPlanes.Add(new Plane(
                new Point3d(150.0, 0.00, 961.5),
                new Vector3d(0.00, 1.00, 0.00)));
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(464.0, 0.00, 961.5),
                new Vector3d(1.00, 0.00, 0.00)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(750.00, 0.00, 961.50),
                new Vector3d(0.00, 1.00, 0.00)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(815.00, 0.00, 961.50),
                new Vector3d(1.00, 0.00, 0.00)));
            ...
            if (externalAxis.Count != 0)
            {
                ...
                robotInfo = new RobotInfo("IRB1600-X/1.2", meshes, axisPlanes, axisLimits, positionPlane, mountingFrame, toolGoo.Value, externalAxis);
            }
            else
            {
                robotInfo = new RobotInfo("IRB1600-X/1.2", meshes, axisPlanes, axisLimits, positionPlane, mountingFrame, toolGoo.Value);
            }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                //return Properties.Resources.IRB1600_X_1_2_Icon;
                return null; // Todo
            }
        }
        ...
        {
            get { return new Guid("D917C5F4-DBD9-4198-B8AB-2311771302F6"); }
        }
    }
}