...
namespace RobotComponents.ABB.Presets.Robots
{
    ...
    public static class IRB1520ID_4_150
    {
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                Mesh.FromJSON(Properties.Resources.IRB1520ID_4_150_link_0) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1520ID_4_150_link_1) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1520ID_4_150_link_2) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1520ID_4_150_link_3) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1520ID_4_150_link_4) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1520ID_4_150_link_5) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB1520ID_4_150_link_6) as Mesh,
            };
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 2
            axisPlanes.Add(new Plane(
                new Point3d(160.0, 0.0, 453),
                new Vector3d(0, 1, 0)));
            // Axis 3
            axisPlanes.Add(new Plane(
                new Point3d(160.0, 0.0, 453.0 + 590),
                new Vector3d(0, 1, 0)));
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(160.0, 0.0, 453.0 + 590.0 + 200),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(160.0 + 723.0, 0, 453.0 + 590.0 + 200),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(160.0 + 723.0 + 200.0, 0, 453.0 + 590.0 + 200),
                new Vector3d(1, 0, 0)));
