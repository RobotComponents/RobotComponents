...
namespace RobotComponentsABB.Components.Definitions
{
    ...
    public class IRB2600_12_1_85_Component : GH_Component
    {
        ...
        public IRB2600_12_1_85_Component()
          : base("ABB_IRB2600-12/1.85", "IRB2600",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // Base
            string linkString = RobotComponentsABB.Properties.Resources.IRB2600_12_1_85_link_0;
            meshes.Add((Mesh)GH_Convert.ByteArrayToCommonObject<GeometryBase>(System.Convert.FromBase64String(linkString)));
            // Axis 1
            linkString = RobotComponentsABB.Properties.Resources.IRB2600_12_1_85_link_1;
            meshes.Add((Mesh)GH_Convert.ByteArrayToCommonObject<GeometryBase>(System.Convert.FromBase64String(linkString)));
            // Axis 2
            linkString = RobotComponentsABB.Properties.Resources.IRB2600_12_1_85_link_2;
            meshes.Add((Mesh)GH_Convert.ByteArrayToCommonObject<GeometryBase>(System.Convert.FromBase64String(linkString)));
            // Axis 3
            ...
            if (externalAxis.Count != 0)
            {
                ...
                robotInfo = new RobotInfo("IRB2600-12/1.85", meshes, axisPlanes, axisLimits, positionPlane, mountingFrame, toolGoo.Value, externalAxis);
            }

            else
            {
                robotInfo = new RobotInfo("IRB2600-12/1.85", meshes, axisPlanes, axisLimits, positionPlane, mountingFrame, toolGoo.Value);
            }
