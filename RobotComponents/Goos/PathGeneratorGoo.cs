...
namespace RobotComponents.Goos
{
    ...
    public class PathGeneratorGoo : GH_GeometricGoo<PathGenerator>, IGH_PreviewData
    {
        ...
        /// </summary>
        /// <param name="pathGenerator"> PathGenerator Value to store inside this Goo instance. </param>
        ...
        {
            return DuplicatePathGeneratorGoo();
        }
        ...
        /// </summary>
        /// <returns> A duplicate of the PathGeneratorGoo. </returns>
        public PathGeneratorGoo DuplicatePathGeneratorGoo()
        {
        ...
        /// <param name="pathGenerator"> Pointer to target of cast. </param>
