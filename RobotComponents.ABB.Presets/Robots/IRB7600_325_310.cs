...
namespace RobotComponents.ABB.Presets.Robots
{
    ...
    {
        /// <summary>
        /// Returns a new IRB7600-325/3.1 Robot instance.
        /// </summary>
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                Mesh.FromJSON(Properties.Resources.IRB7600_325_310_link_0) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB7600_325_310_link_1) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB7600_325_310_link_2) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB7600_325_310_link_3) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB7600_325_310_link_4) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB7600_325_310_link_5) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB7600_325_310_link_6) as Mesh,
            };
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(410 + 1556, 0, 780 + 1075 + 165),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(410 + 1556 + 250, 0, 780 + 1075 + 165),
                new Vector3d(1, 0, 0)));
