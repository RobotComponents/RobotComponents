...
{
    /// <summary>
    /// RobotComponents IRB6700-175/3.05 preset component. An inherent from the GH_Component Class.
    /// </summary>
    public class IRB6700_175_3_05_Component : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB6700_175_3_05_Component class.
        /// </summary>
        public IRB6700_175_3_05_Component()
          : base("ABB IRB6700-175/3.05", "IRB6700",
              "An ABB IRB6700-175/3.05 Robot Info preset component."
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robotInfo = IRB6700_175_305.GetRobotInfo(name, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
        ...
        {
            get { return new Guid("274357FE-B57E-4A4C-9F02-4AF8E6F24FBC"); }
        }
