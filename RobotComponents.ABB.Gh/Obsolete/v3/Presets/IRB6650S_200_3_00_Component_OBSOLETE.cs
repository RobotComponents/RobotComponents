...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    public class IRB6650S_200_3_00_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB6650S_200_3_00_Component class.
        /// </summary>
        public IRB6650S_200_3_00_Component_OBSOLETE()
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB6650S_200_300, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
