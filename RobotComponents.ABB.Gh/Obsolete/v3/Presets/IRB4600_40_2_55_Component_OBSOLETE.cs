...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    public class IRB4600_40_2_55_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB4600_40_2_55_Component class.
        /// </summary>
        public IRB4600_40_2_55_Component_OBSOLETE()
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB4600_40_255, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
