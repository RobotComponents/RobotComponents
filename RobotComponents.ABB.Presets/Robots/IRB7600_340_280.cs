...
namespace RobotComponents.ABB.Presets.Robots
{
    ...
    public static class IRB7600_340_280
    {
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                Mesh.FromJSON(Properties.Resources.IRB7600_340_280_link_0) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB7600_340_280_link_1) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB7600_340_280_link_2) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB7600_340_280_link_3) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB7600_340_280_link_4) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB7600_340_280_link_5) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB7600_340_280_link_6) as Mesh,
            };
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(410 + 1306, 0, 780 + 1075 + 165),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(410 + 1306 + 250, 0, 780 + 1075 + 165),
                new Vector3d(1, 0, 0)));
