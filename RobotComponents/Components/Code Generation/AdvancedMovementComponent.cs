...
{
    public class AdvancedMovementComponent : GH_Component, IGH_VariableParameterComponent
    {
        /// <summary>
        ...
        /// </summary>
        public AdvancedMovementComponent()
          : base("Action: Advanced Movement", "AM",
        ...
        {
            pManager.AddParameter(new TargetParameter(), "Target", "T", "Target as Action: Target", GH_ParamAccess.list);
        ...
        {
            get { return new Guid("39A49B5F-11E0-45BB-9025-B35EF6B6A3C8"); }
        }
