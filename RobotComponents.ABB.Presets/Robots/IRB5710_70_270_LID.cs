...
{
    /// <summary>
    /// Represents a collection of methods to get the IRB5710-70/2.7-LID Robot instance.
    /// </summary>
    public static class IRB5710_70_270_LID
    {
        /// <summary>
        /// Returns a new IRB5710-70/2.7-LID Robot instance.
        /// </summary>
        ...
        {
            string name = "IRB5710-70/2.7-LID";
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5710_70_2_70_LID_link_0)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5710_70_2_70_LID_link_1)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5710_70_2_70_LID_link_2)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5710_70_2_70_LID_link_3)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5710_70_2_70_LID_link_4)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5710_70_2_70_LID_link_5)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5710_70_2_70_LID_link_6))
            };
        ...
        {
            Plane[] axisPlanes = Robot.GetAxisPlanesFromKinematicsParameters(Plane.WorldXY, 280, -180, 0, 0, 670, 950, 1460, 290, out _);
        ...
        {
            Robot.GetAxisPlanesFromKinematicsParameters(Plane.WorldXY, 280, -180, 0, 0, 670, 950, 1460, 290, out Plane mountingFrame);
