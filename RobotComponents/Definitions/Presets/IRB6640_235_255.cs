...
namespace RobotComponents.Definitions.Presets
{
    ...
    public static class IRB6640_235_255
    {
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 3
            axisPlanes.Add(new Plane(
                new Point3d(320, 0, 780.0 + 1075),
                new Vector3d(0, 1, 0)));
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(551, 0, 780.0 + 1075.0 + 200),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(320.0 + 1142.5, 0, 780.0 + 1075.0 + 200),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(320.0 + 1142.5 + 200.0, 0, 780.0 + 1075.0 + 200),
                new Vector3d(1, 0, 0)));
