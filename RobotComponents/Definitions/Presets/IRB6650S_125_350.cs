...
namespace RobotComponents.Definitions.Presets
{
    ...
    /// </summary>
    public static class IRB6650S_125_350
    {
        /// <summary>
        /// Returns a new IRB6650S-125/3.50 Robot instance.
        /// </summary>
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            // Base
            linkString = RobotComponents.Properties.Resources.IRB6650S_125_3_50_link_0;
            meshes.Add((Mesh)HelperMethods.ByteArrayToObject(System.Convert.FromBase64String(linkString)));
            // Axis 1
            linkString = RobotComponents.Properties.Resources.IRB6650S_125_3_50_link_1;
            meshes.Add((Mesh)HelperMethods.ByteArrayToObject(System.Convert.FromBase64String(linkString)));
            // Axis 2
            linkString = RobotComponents.Properties.Resources.IRB6650S_125_3_50_link_2;
            meshes.Add((Mesh)HelperMethods.ByteArrayToObject(System.Convert.FromBase64String(linkString)));
            // Axis 3
            linkString = RobotComponents.Properties.Resources.IRB6650S_125_3_50_link_3;
            meshes.Add((Mesh)HelperMethods.ByteArrayToObject(System.Convert.FromBase64String(linkString)));
            // Axis 4
            linkString = RobotComponents.Properties.Resources.IRB6650S_125_3_50_link_4;
            meshes.Add((Mesh)HelperMethods.ByteArrayToObject(System.Convert.FromBase64String(linkString)));
            // Axis 5
            linkString = RobotComponents.Properties.Resources.IRB6650S_125_3_50_link_5;
            meshes.Add((Mesh)HelperMethods.ByteArrayToObject(System.Convert.FromBase64String(linkString)));
            // Axis 6
            linkString = RobotComponents.Properties.Resources.IRB6650S_125_3_50_link_6;
            meshes.Add((Mesh)HelperMethods.ByteArrayToObject(System.Convert.FromBase64String(linkString)));
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 2
            axisPlanes.Add(new Plane(
                new Point3d(600, 0.00, 630),
                new Vector3d(0.00, 1.00, 0.00)));
            // Axis 3
            axisPlanes.Add(new Plane(
                new Point3d(600, 0.00, 630 + 1280),
                new Vector3d(0.00, 1.00, 0.00)));
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(830, 0.00, 630 + 1280 + 200),
                new Vector3d(1.00, 0.00, 0.00)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(600 + 1592, 0.00, 630 + 1280 + 200),
                new Vector3d(0.00, 1.00, 0.00)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(600 + 1592 + 200, 0.00, 630 + 1280 + 200),
                new Vector3d(1.00, 0.00, 0.00)));
        ...
        public static List<Interval> GetAxisLimits()
        {
            ...
            axisLimits.Add(new Interval(-40, 160));
