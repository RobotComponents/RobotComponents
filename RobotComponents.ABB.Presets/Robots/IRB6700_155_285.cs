...
namespace RobotComponents.ABB.Presets.Robots
{
    ...
    {
        /// <summary>
        /// Returns a new IRB6700-155/2.85 Robot instance.
        /// </summary>
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                Mesh.FromJSON(Properties.Resources.IRB6700_155_285_link_0) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB6700_155_285_link_1) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB6700_155_285_link_2) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB6700_155_285_link_3) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB6700_155_285_link_4) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB6700_155_285_link_5) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB6700_155_285_link_6) as Mesh,
            };
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(320 + 1392.5, 0, 780 + 1125 + 200),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(320 + 1392.5 + 200, 0, 780 + 1125 + 200),
                new Vector3d(1, 0, 0)));
