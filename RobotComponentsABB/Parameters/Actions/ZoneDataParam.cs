...
namespace RobotComponentsABB.Parameters.Actions
{
    ...
    /// Zone Data parameter
    /// </summary>
    public class ZoneDataParameter : GH_PersistentGeometryParam<GH_ZoneData>, IGH_PreviewObject
    {
        /// <summary>
        /// Initializes a new instance of the GH_PersistentGeometryParam<GH_ZoneData> class
        /// </summary>
