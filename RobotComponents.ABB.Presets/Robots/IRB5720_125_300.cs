...
{
    /// <summary>
    /// Represents a collection of methods to get the IRB5720-125/3.0 Robot instance.
    /// </summary>
    public static class IRB5720_125_300
    {
        /// <summary>
        /// Returns a new IRB5720-125/3.0 Robot instance.
        /// </summary>
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5720_125_3_00_link_0)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5720_125_3_00_link_1)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5720_125_3_00_link_2)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5720_125_3_00_link_3)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5720_125_3_00_link_4)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5720_125_3_00_link_5)),
                (Mesh)Serialization.ByteArrayToObject(Convert.FromBase64String(Properties.Resources.IRB5720_125_3_00_link_6))
            };
        ...
        {
            Plane[] axisPlanes = Robot.GetAxisPlanesFromKinematicsParameters(Plane.WorldXY, 320, -200, 0, 0, 670, 1120, 1547.5, 167, out _);
        ...
        {
            Robot.GetAxisPlanesFromKinematicsParameters(Plane.WorldXY, 320, -200, 0, 0, 670, 1120, 1547.5, 167, out Plane mountingFrame);
