...
namespace RobotComponents.ABB.Gh.Obsolete
{
    ...
    public class IRB140_6_0_81_Component_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the IRB140_6_0_81_Component class.
        /// </summary>
        public IRB140_6_0_81_Component_OBSOLETE()
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            try
            {
                robot = Factory.GetRobotPreset(RobotPreset.IRB140_6_081, positionPlane, tool, externalAxis);
            }
            catch (Exception ex)
            {
