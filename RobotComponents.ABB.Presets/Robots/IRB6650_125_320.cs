...
namespace RobotComponents.ABB.Presets.Robots
{
    ...
    /// </summary>
    public static class IRB6650_125_320
    {
        /// <summary>
        /// Returns a new IRB6650-125/3.2 Robot instance.
        /// </summary>
        ...
        public static List<Mesh> GetMeshes()
        {
            ...
            {
                Mesh.FromJSON(Properties.Resources.IRB6650_125_320_link_0) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB6650_125_320_link_1) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB6650_125_320_link_2) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB6650_125_320_link_3) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB6650_125_320_link_4) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB6650_125_320_link_5) as Mesh,
                Mesh.FromJSON(Properties.Resources.IRB6650_125_320_link_6) as Mesh,
            };
        ...
        public static List<Plane> GetAxisPlanes()
        {
            ...
            // Axis 3
            axisPlanes.Add(new Plane(
                new Point3d(320, 0, 2060),
                new Vector3d(0, 1, 0)));
            // Axis 4
            axisPlanes.Add(new Plane(
                new Point3d(550, 0, 2260),
                new Vector3d(1, 0, 0)));
            // Axis 5
            axisPlanes.Add(new Plane(
                new Point3d(1912, 0, 2260),
                new Vector3d(0, 1, 0)));
            // Axis 6
            axisPlanes.Add(new Plane(
                new Point3d(2112, 0, 2260),
                new Vector3d(1, 0, 0)));
